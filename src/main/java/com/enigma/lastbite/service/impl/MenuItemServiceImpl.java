...
public class MenuItemServiceImpl implements MenuItemService {
    ...
    @Override
    public Double averageRatingBySellerProfileId(String sellerId) {
        return menuItemRepository.findAverageRatingBySellerProfileId(sellerId);
    }
...
//        log.info("Running task to update status of expired menu items...");
//        menuItemRepository.updateStatusForExpiredItems(LocalDateTime.now());
//    }
}