...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtResponse login(LoginRequest loginRequest) {
        ...
        // Get email dari User entity jika UserDetails adalah instance dari User
        String email = null;
    ...
    public TokenRefreshResponse refreshToken(TokenRefreshRequest request) {
        ...
        // Cek apakah ini refresh token
        if (!jwtUtils.isRefreshToken(requestRefreshToken)) {
            throw new CustomException(ErrorCode.NOT_REFRESH_TOKEN);
        }

        // Dapatkan username dari refresh token
        String username = jwtUtils.getUsernameFromJwtToken(requestRefreshToken);

        // Load user details untuk mendapatkan roles dari database
        // Ini lebih aman karena kita memastikan user masih ada dan roles masih valid
