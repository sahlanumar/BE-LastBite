...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CommonResponse<UserResponse>> updateUserById(
            @PathVariable String id,
            @Validated(ValidationGroups.Update.class) @RequestBody UserUpdateRequest request) {
    ...
    public ResponseEntity<CommonResponse<UserResponse>> changePasswordById(
            @PathVariable String id,
            @Validated(ValidationGroups.Update.class) @RequestBody PasswordChangeRequest request) {
        UserResponse response = userService.updatePasswordById(id, request);
        return ResponseUtil.buildResponse(HttpStatus.OK, ResponseMessage.SUCCESS_UPDATE_DATA, response);
    }

    @PutMapping("/me/password")
    public ResponseEntity<CommonResponse<UserResponse>> changePassword(
            @Validated(ValidationGroups.Update.class) @RequestBody PasswordChangeRequest request) {
