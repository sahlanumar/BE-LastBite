...
import com.enigma.lastbite.security.AuthEntryPointJwt;
import com.enigma.lastbite.security.AuthTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        // =============================================================================
                        // MENU ITEMS (PUBLIC & SELLER/ADMIN)
                        // =============================================================================
                        .requestMatchers(HttpMethod.GET, "/api/menu-items/me").hasRole("SELLER")
                        .requestMatchers(HttpMethod.GET, "/api/menu-items", "/api/menu-items/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/menu-items").hasAnyRole("ADMIN", "SELLER")
                        .requestMatchers(HttpMethod.PUT, "/api/menu-items/**").hasAnyRole("ADMIN", "SELLER")
                        .requestMatchers(HttpMethod.DELETE, "/api/menu-items/**").hasAnyRole("ADMIN", "SELLER")

                        // =============================================================================
                        // REVIEWS (PUBLIC & CUSTOMER/ADMIN)
                        // =============================================================================
                        .requestMatchers(HttpMethod.GET, "/api/menu-item-reviews/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/menu-item-reviews").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.DELETE, "/api/menu-item-reviews/**").hasAnyRole("ADMIN", "CUSTOMER")

                        // =============================================================================
                        // ORDERS (VARIOUS ROLES)
                        // =============================================================================
                        .requestMatchers(HttpMethod.GET, "/api/orders/customer/me").hasRole("CUSTOMER")
                        .requestMatchers(HttpMethod.GET, "/api/orders/seller/me").hasRole("SELLER")
                        .requestMatchers(HttpMethod.GET, "/api/orders").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/orders").hasRole("CUSTOMER")
                        .requestMatchers("/api/orders/{orderId}/accept", "/api/orders/{orderId}/ready", "/api/orders/{orderId}/complete").hasRole("SELLER")
                        .requestMatchers("/api/orders/{orderId}/cancel").hasAnyRole("ADMIN", "SELLER", "CUSTOMER")
                        .requestMatchers(HttpMethod.GET, "/api/orders/**").hasAnyRole("ADMIN", "CUSTOMER", "SELLER")

                        // =============================================================================
                        // PAYMENTS (CUSTOMER & PUBLIC WEBHOOK)
                        // =============================================================================
                        .requestMatchers(HttpMethod.POST, "/api/payments/midtrans-notification").permitAll()
                        .requestMatchers("/api/payments/**").hasRole("CUSTOMER")

                        // =============================================================================
                        // SELLERS (PUBLIC & ADMIN/SELLER)
                        // =============================================================================
                        .requestMatchers(HttpMethod.GET, "/api/sellers/user/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/sellers", "/api/sellers/**").hasAnyRole("ADMIN", "SELLER")
                        .requestMatchers(HttpMethod.PUT, "/api/sellers/**").hasAnyRole("ADMIN", "SELLER")
